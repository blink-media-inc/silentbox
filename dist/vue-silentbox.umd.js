(function (global, factory) {
    ...
    var script = {
        ...
        destroyed: function destroyed() {
            var index = lodash.findIndex(this.$parent.items.list, {
                src: this.src,
                autoplay: this.autoplay,
                item: this.item,
                desc: this.description,
